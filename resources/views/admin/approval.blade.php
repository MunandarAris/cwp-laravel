                        ...
                        <table class="table m-0 align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($item['is_active'] == 1)
                                            <a class="btn btn-danger" id="btn-modal" onclick="changeApprovalStatus({{$item['id']}})"><i class="fa fa-sync"></i>&nbsp; Disapprove</a>
                                        @else
                                            <a class="btn btn-danger" id="btn-modal" onclick="changeApprovalStatus({{$item['id']}})"><i class="fa fa-sync"></i>&nbsp; Approve</a>
                                        @endif
